...
impl FileEntry {
    ...
    pub fn stat(&self, /* stat: &mut Kstat */) {
        ...
        // stat.st_mtime_sec = modify.time.sec();
        // stat.st_mtime_nsec = modify.time.msec() * 1000000;
        // stat.st_ctime_sec = create.time.sec();
        // stat.st_ctime_nsec = create.time.msec() * 10000000;
    }
}
